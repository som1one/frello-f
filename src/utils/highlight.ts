...
export const mealKeywords =
	/(?:Завтрак|Обед|Ужин|Полдник|Перекус|Первый Перекус|Ланч|Десерт|Второй завтрак|Утренний перекус|Поздний ужин|Фуршет|Кофе-брейк|Бранч|Ранний завтрак|Перекус \d+|Напитки)(?:\s*\(.*?\))?:/gi

// Дни недели и планы питания
export const weekDaysKeywords =
	/(?:Понедельник|Вторник|Среда|Четверг|Пятница|Суббота|Воскресенье)(?:\s*\(.*?\))?:/gi
export const mealPlanKeywords =
	/(?:Прием пищи \d+|День \d+|План питания на день|План питания на \d+ дней|План питания на \d+ дня|План питания на неделю|План питания на \d+ недель|План питания на \d+ недели)(?:\s*\(.*?\))?:/gi
